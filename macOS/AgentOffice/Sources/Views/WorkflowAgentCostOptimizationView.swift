// WorkflowAgentCostOptimizationView.swift
import SwiftUI

struct WorkflowAgentCostOptimizationView: View {
    ...
    private let optimizations: [(String, String, String, Double)] = [
        ...
        ("Use smaller models for review", "Switch to Haiku for code review tasks", "Saves ~$0.10/day", 0.10),
