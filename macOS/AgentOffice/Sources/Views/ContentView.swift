...
struct ContentView: View {
    ...
    var body: some View {
        ...
        .sheet(isPresented: $store.showSessionRestore) { WorkflowAgentSessionRestoreView() }
        ...
        .sheet(isPresented: $store.showAgentLeaderboard) { WorkflowAgentAgentLeaderboardView() }
        .sheet(isPresented: $store.showAgentComparison) { WorkflowAgentAgentComparisonView() }
        .sheet(isPresented: $store.showAgentPerformanceTrend) { WorkflowAgentAgentPerformanceTrendView() }
        ...
        .sheet(isPresented: $store.showAgentCommunicationLog) { WorkflowAgentAgentCommunicationLogView() }
        .sheet(isPresented: $store.showAgentDependencyGraph) { WorkflowAgentAgentDependencyGraphView() }
        .sheet(isPresented: $store.showAgentAvailability) { WorkflowAgentAgentAvailabilityView() }
        .sheet(isPresented: $store.showAgentSchedulingCalendar) { WorkflowAgentAgentSchedulingView() }
        ...
        .sheet(isPresented: $store.showTemplateDesigner) { WorkflowAgentPromptDesignerView() }
        ...
        .sheet(isPresented: $store.showStorageDetails) { WorkflowAgentAgentStorageDetailsView() }
        .sheet(isPresented: $store.showAgentSchedulingCalendar) { WorkflowAgentAgentSchedulingCalendarView() }
        .sheet(isPresented: $store.showAgentInteractionMatrix) { WorkflowAgentAgentInteractionMatrixView() }
        .sheet(isPresented: $store.showAgentAvailability) { WorkflowAgentAgentAvailabilityView() }
        .sheet(isPresented: $store.showAgentMemoryManager) { WorkflowAgentAgentMemoryView() }
        ...
        .sheet(isPresented: $store.showAgentHealthDetail) { WorkflowAgentAgentHealthDetailView() }
        .sheet(isPresented: $store.showWorkspaceOverview) { WorkflowAgentAgentWorkspaceOverviewView() }
