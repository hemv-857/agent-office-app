...
final class AppStore: ObservableObject {
    ...
    @Published var showAgentDashboard = false
    @Published var showSettingsManager = false
    @Published var showActivityMonitor = false
    @Published var showSettingsViewer = false
    ...
    @Published var showWorkflowOptimization = false
    ...
    @Published var showAgentTraining = false
    @Published var showWorkflowScheduler = false
    ...
    @Published var showAgentWorkload = false
    ...
    @Published var showWorkflowExecution = false
    @Published var showCostBreakdownDetail = false
    @Published var showCostOptimizationDetail = false
